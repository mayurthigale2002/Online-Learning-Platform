...
import studentCourses from "../../data/professionalCourses";
...
const ProfLearning = () => {
  ...
  return (
    <>
      ...
      >
        Welcome To Professional Learning Courses..
      </h1>
            ...
            <Col md={4} key={course.id}>
              <Card className="certification-card mb-4 shadow-sm bg-dark text-white">
                <Card.Body>
                  ...
                  <small className="text-warning">{course.duration}</small>
                </Card.Body>
              </Card>
            </Col>
          ))}
